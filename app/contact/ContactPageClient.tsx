...
const jsonLd = {
  ...
  "@type": "ContactPage",
  name: "Contact Vidhaana",
  description: "Contact page for Vidhaana AI legal assistant",
        ...
        <section className="py-20 lg:py-32">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h1 className="text-4xl md:text-6xl font-bold text-black mb-6">Contact Our AI Legal Experts</h1>
              <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
                Get in touch with our team for professional AI-powered legal assistance and expert support
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-black text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              For urgent legal matters, our AI assistant is available 24/7 to provide immediate professional guidance
            </p>
